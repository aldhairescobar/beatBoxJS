let beats = {
    ...
    "75": {
        beat: new Beat("./assets/orchestra.wav"),
        button: new Button('#FFFFFF', 75)
    },
    "76": {
        beat: new Beat("./assets/trap.wav"),
...
triggerBeat = (event) => {
    ...
    let keyInBeats = beats[event.keyCode]
    
    if(keyCode in beats){

        keyInBeats.beat.playAudio();
        keyInBeats.button.select();
    }
}
 ...
 */
 document.addEventListener("keydown", () =>  triggerBeat(event));